      ...
      >
        ...
        >
          ...
          <input
            v-model="query"
            type="search"
            class="form-control block w-full md:w-2/4 my-2 md:my-0 px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0"
